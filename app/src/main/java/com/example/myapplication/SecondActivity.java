...
public class SecondActivity extends AppCompatActivity implements
    ...
    Button backToMainActivityButton,b1;
    ...
    {
        Intent Cal=new Intent(SecondActivity.this,Calculator.class);
        startActivity(Cal);

    }
    public void Calendar(View v)
    {
        Intent Calendar=new Intent(SecondActivity.this,Calendar.class);
        startActivity(Calendar);

    }
    public void Contacts(View v)
    {
        Intent Calendar=new Intent(SecondActivity.this,Contacts.class);
        startActivity(Calendar);

    }
    public void Gallery(View v)
    {
        Intent Cal=new Intent(SecondActivity.this,Gallery.class);
        startActivity(Cal);
